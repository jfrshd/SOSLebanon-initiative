...
exports.handler = async (event) => {
  let params = {
    ...
    ProjectionExpression: "id,contactName,contactEmail,contactPhone,#category,#location,description,helpDescription,facebookAccount,instagramAccount,twitterAccount,linkedInAccount,image,#keyword,fulfilled,updatedDate",
